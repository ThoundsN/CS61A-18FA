...
def count_change(amount):
    ...
    def constrained_count(amount,smallest_coin):
        ...
        withsmallestcoin =  constrained_count(amount-smallest_coin,smallest_coin)
        withoutsmallestcoin = constrained_count(amount,smallest_coin*2)
        return withoutsmallestcoin +  withsmallestcoin
